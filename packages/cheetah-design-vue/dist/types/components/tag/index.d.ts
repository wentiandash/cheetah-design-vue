export declare const ChTag: import("../../utils").SFCWithInstall<{
    new (...args: any[]): {
        $: import("vue").ComponentInternalInstance;
        $data: {};
        $props: {
            mode?: import("./src").TagType | undefined;
            state?: import("../component").ComponentState | undefined;
            shape?: import("./src").TagShape | undefined;
        ...
        $options: import("vue").ComponentOptionsBase<Readonly<import("vue").ExtractPropTypes<{
            mode: {
                type: import("vue").PropType<import("./src").TagType>;
                default: string;
            };
            state: {
            ...
            shape: {
                type: import("vue").PropType<import("./src").TagShape>;
                default: string;
            };
            closable: {
            ...
            mode: import("./src").TagType;
            state: import("../component").ComponentState;
            shape: import("./src").TagShape;
        }, {}, string, {}> & {
