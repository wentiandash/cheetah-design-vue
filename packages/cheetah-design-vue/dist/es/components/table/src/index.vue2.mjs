...
import { genTableConfig } from "./index.mjs";
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ref_key: "tableEl",
        ref: tableEl,
        class: normalizeClass(["ch-table", { "ch-table--border": !_ctx.border }])
      }, [
        createElementVNode("div", {
          class: normalizeClass(["ch-table-header", { "ch-table-header--fixed": _ctx.fixedHeader }])
        }, [
