...
const Breadcrumb = /* @__PURE__ */ defineComponent({
  ...
  setup(props, {
    ...
    return () => {
      var _a;
      return createVNode(Fragment, null, [(_a = steps.value) == null ? void 0 : _a.map((step, index) => createVNode(Fragment, null, [withDirectives(createVNode("span", null, [props.separator]), [[vShow, index !== 0]]), createVNode(ChButton, {
        "size": "mini",
        "mode": "link",
        "iconLeft": step.icon,
