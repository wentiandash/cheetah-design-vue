...
Object.defineProperty(Immutable.__exports, "__esModule", {
  value: true
});
Immutable.__exports.test = Immutable.__exports.serialize = Immutable.__exports.default = void 0;
...
Immutable.__exports.serialize = serialize;
const test = (val) => val && (val[IS_ITERABLE_SENTINEL] === true || val[IS_RECORD_SENTINEL] === true);
Immutable.__exports.test = test;
const plugin = {
  serialize,
  test
};
var _default = plugin;
Immutable.__exports.default = _default;
