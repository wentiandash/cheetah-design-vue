...
const compilerDom_esmBundler = require("../../../../../@vue_compiler-dom@3.3.4/node_modules/@vue/compiler-dom/dist/compiler-dom.esm-bundler.js");
...
function processSlot(source, Vue$1) {
  ...
  var code = compilerDom_esmBundler.compile("<transition>".concat(template, "</transition>"), {
    mode: "function",
  ...
  return Vue.defineComponent({
    ...
    setup: function(props, _a2) {
      ...
      return function() {
        ...
        return Vue.h(tag, stubProps, renderStubDefaultSlot ? slots : void 0);
      };
    }
  });
};
...
function createStubComponentsTransformer(_a) {
  var _b = _a.stubs, stubs2 = _b === void 0 ? {} : _b, _c = _a.shallow, shallow = _c === void 0 ? false : _c, _d = _a.renderStubDefaultSlot, renderStubDefaultSlot = _d === void 0 ? false : _d;
  return function componentsTransformer(type, instance) {
    ...
    if ((type === Vue.Transition || type === Vue.BaseTransition) && "transition" in stubs2) {
    ...
    if (type === Vue.TransitionGroup && "transition-group" in stubs2) {
    ...
    if (stub === true || shallow) {
      ...
      var newStub = (_c2 = (_b2 = (_a2 = config.plugins).createStubs) === null || _b2 === void 0 ? void 0 : _b2.call(_a2, {
        name: stubName,
        component: type
...
exports.mount = mount;
//# sourceMappingURL=vue-test-utils.esm-bundler.js.map
